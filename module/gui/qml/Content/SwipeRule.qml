...
Item {
        ...
        Column{
            ...
            Item{
                ...
                FComboBox{
                    ...
                    width: 200
                    model: ["defalut", "vector"]
                    currentIndex: if(typeof ruleFile.currentItem !== "undefined"){
                                     if(ruleFile.currentItem.mode === "default"){
                                         return 0
                                     }else{
                                         return 1
                                     }
                    ...
                    onActivated: {
                        console.debug('接收',currentIndex, currentText)
                        if(currentIndex === 0){
                            ruleFile.currentItem.mode = "default"
                        }
                        else if(currentIndex === 1){
                            ruleFile.currentItem.mode = "vector"
                        }
                    }
                }
            }
    ...
    FluArea{
        ...
        FluText{
            leftPadding: 12
            topPadding: 12
            text: "红色的框(Roi front)表示滑动的起始范围，绿色的框(Roi back)表示滑动的停止范围。
