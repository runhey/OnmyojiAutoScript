...
from tasks.Component.GeneralInvite.assets import I_INVITE_ENSURE
...
class WantedQuestsAssets: 
	...
	# 点击邀请 
	I_INVITE_WQ = RuleImage(roi_front=(506,544,132,60), roi_back=(506,544,132,60), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_invite_ensure.png")
