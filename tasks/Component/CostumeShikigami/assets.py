...
class CostumeShikigamiAssets: 
	...
	# 点击御魂 
	I_ST_SOULS_1 = RuleImage(roi_front=(1184,232,70,80), roi_back=(1182,231,70,80), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeShikigami/sk1/sk1_st_souls_1.png")
	# 更换 
