...
class GeneralBattleAssets: 
	...
	# 结算紫蛇皮 
	I_REWARD_PURPLE_SNAKE_SKIN = RuleImage(roi_front=(283,214,67,37), roi_back=(254,163,797,261), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_reward_purple_snake_skin.png")
	# 结算金蛇皮 
