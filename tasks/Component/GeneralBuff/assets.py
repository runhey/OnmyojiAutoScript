...
class GeneralBuffAssets: 
	...
	# 用来判定是否点击的那个 
	I_CLOUD = RuleImage(roi_front=(357,503,65,38), roi_back=(357,503,65,38), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_cloud.png")
