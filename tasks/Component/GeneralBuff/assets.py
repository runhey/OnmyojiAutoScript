...
class GeneralBuffAssets: 
	...
	# description 
	I_EXP_50 = RuleImage(roi_front=(379,406,44,42), roi_back=(365,127,70,393), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_exp_50.png")
	# description 
	I_EXP_100 = RuleImage(roi_front=(383,406,44,40), roi_back=(368,126,58,386), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_exp_100.png")
	# description 
	...
	# 用来判定是否点击的那个 
	I_CLOUD = RuleImage(roi_front=(356,505,65,38), roi_back=(356,505,65,36), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBuff/gb/gb_cloud.png")
