...
class CostumeBattleAssets: 
	...
	# Image Rule Assets
	# 指针 
	I_LOCAL_8 = RuleImage(roi_front=(30,566,23,25), roi_back=(30,566,23,25), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeBattle/battle8/battle7_local_8.png")
	# 左上角退出 
	I_EXIT_8 = RuleImage(roi_front=(22,17,27,31), roi_back=(22,17,27,31), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeBattle/battle8/battle7_exit_8.png")
	# 左上角好友 
	I_FRIENDS_8 = RuleImage(roi_front=(89,18,35,34), roi_back=(89,18,35,34), threshold=0.8, method="Template matching", file="./tasks/Component/CostumeBattle/battle8/battle6_friends_8.png")
