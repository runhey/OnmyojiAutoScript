...
class RestartAssets: 
	...
	# 一键已读所有邮件 
	I_READ_ALL_MAIL = RuleImage(roi_front=(198,605,91,34), roi_back=(149,588,182,72), threshold=0.8, method="Template matching", file="./tasks/Restart/harvest/harvest_read_all_mail.png")
