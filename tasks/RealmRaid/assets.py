...
class RealmRaidAssets: 
	...
	# 五个勋章 
	I_MEDAL_5 = RuleImage(roi_front=(238,205,212,54), roi_back=(216,187,919,364), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_medal_5.png")
	# description 
	...
	# description 
	I_MEDAL_3 = RuleImage(roi_front=(240,210,194,42), roi_back=(229,189,894,345), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_medal_3.png")
	# description 
	...
	# 进攻 
	I_FIRE = RuleImage(roi_front=(982,494,130,58), roi_back=(140,129,1024,584), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_fire.png")
	# 打完个后出现的领取奖励 
	...
	# 呱太入侵， 第一次进入结界时候出现 
	I_FROG_RAID = RuleImage(roi_front=(520,310,290,100), roi_back=(520,310,290,100), threshold=0.8, method="Template matching", file="./tasks/RealmRaid/res/res_frog_raid.png")
	# 个人 
