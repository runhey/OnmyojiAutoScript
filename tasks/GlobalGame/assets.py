...
class GlobalGameAssets: 
	...
	# 短一点的取消 
	I_UI_CANCEL_SAMLL = RuleImage(roi_front=(472,389,130,62), roi_back=(472,389,130,62), threshold=0.7, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_cancel_samll.png")
	# description 
