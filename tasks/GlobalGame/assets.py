...
class GlobalGameAssets: 
	...
	# '获得奖励' 四个大字 
	I_UI_REWARD = RuleImage(roi_front=(481,185,338,44), roi_back=(464,142,350,145), threshold=0.73, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_reward.png")
	# description 
	...
	# 短一点的确认 
	I_UI_CONFIRM_SAMLL = RuleImage(roi_front=(677,390,130,62), roi_back=(677,390,130,62), threshold=0.7, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_confirm_samll.png")
	# 短一点的取消 
	I_UI_CANCEL_SAMLL = RuleImage(roi_front=(472,389,130,62), roi_back=(472,389,127,62), threshold=0.7, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_cancel_samll.png")
	# description 
