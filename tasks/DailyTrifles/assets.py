...
class DailyTriflesAssets: 
	...
	# Image Rule Assets
	# 礼包屋 
	I_ROOM_GIFT = RuleImage(roi_front=(1143,636,69,64), roi_back=(1143,636,69,64), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_room_gift.png")
	# description 
	...
	# 免费一抽 
	I_GIFT_SIGN = RuleImage(roi_front=(201,207,100,143), roi_back=(201,207,100,143), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_gift_sign.png")
