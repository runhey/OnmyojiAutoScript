...
class DailyTriflesAssets: 
	...
	# 免费一抽 
	I_GIFT_SIGN = RuleImage(roi_front=(629,192,129,149), roi_back=(629,192,129,149), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_gift_sign.png")
	# 体力 
	I_SPECIAL_SUSHI = RuleImage(roi_front=(180,130,800,460), roi_back=(180,130,800,460), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_special_sushi.png")
	# 购买时货币类型为勾玉 
