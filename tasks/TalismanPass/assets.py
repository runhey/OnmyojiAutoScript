...
class TalismanPassAssets: 
	...
	# 点击随机御魂 
	I_TP_SOUL_1 = RuleImage(roi_front=(248,501,34,37), roi_back=(165,389,929,168), threshold=0.7, method="Template matching", file="./tasks/TalismanPass/tp/tp_tp_soul_1.png")
	# 选择中间第二个御魂 
