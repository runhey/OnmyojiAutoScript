...
class ScriptTask(GameUi, GeneralBattle, DemonEncounterAssets, SwitchSoul):
    ...
    def checkout_soul(self):
        ...
        if today == 0:
            ...
            if best_soul_config.enable and best_demon_boss_config.best_demon_oboroguruma_select:
                group, team = best_soul_config.best_demon_oboroguruma.split(",")
            else:
                group, team = soul_config.demon_oboroguruma.split(",")
        elif today == 6:
            if best_soul_config.enable and best_demon_boss_config.best_demon_nightly_aramitama_select:
                group, team = best_soul_config.best_demon_nightly_aramitama.split(",")
            else:
