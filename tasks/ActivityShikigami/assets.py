...
class ActivityShikigamiAssets: 
	...
	# 活动票数（没有百分比） 
	O_REMAIN_PASS2 = RuleOcr(roi=(1136.3333333333333,17.3333333333334,88,29), area=(1134.3333333333333,17.666666666666742,88,29), mode="Digit", method="Default", keyword="", name="remain_pass2")
	# boss剩余攻击次数 
	...
	# Ocr-description 
	O_REMAIN_AP100_MAIN = RuleOcr(roi=(904.9999999999999,25.000000000000057,120,32), area=(901.9999999999999,17.3333333333334,129.33333333333326,42), mode="Digit", method="Default", keyword="", name="remain_ap100_main")
