...
class FloatParadeAssets: 
	...
	# Image Rule Assets
	# 从庭院进入花车活动 
	I_FP_ACCESS = RuleImage(roi_front=(183,413,36,34), roi_back=(95,344,1042,229), threshold=0.8, method="Template matching", file="./tasks/FloatParade/fp/fp_fp_access.png")
	# description 
