...
class GameUiAssets: 
	...
	# description 
	I_MAIN_GOTO_TEAM = RuleImage(roi_front=(429,622,77,55), roi_back=(429,622,77,55), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_main_goto_team.png")
	# description 
