...
class GameUiAssets: 
	...
	# description 
	I_CHECK_REALM_RAID = RuleImage(roi_front=(113,625,86,76), roi_back=(113,625,86,77), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_realm_raid.png")
	# description 
