...
class GameUiAssets: 
	...
	# 是否为展开绘卷 
	I_CHECK_EXPANDED = RuleImage(roi_front=(1173,627,47,79), roi_back=(1173,627,47,79), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_expanded.png")
