...
page_climb_act.additional = [gga.I_UI_REWARD, asa.I_SKIP_BUTTON, asa.I_RED_EXIT_2]
...
page_climb_act_2.additional = [asa.I_SKIP_BUTTON, gga.I_UI_REWARD, asa.I_RED_EXIT]
...
page_climb_act_3 = Page(asa.I_ENTRY_ACTIVITY)
page_climb_act_3.additional = [asa.I_PASS_ACT_LOCAT, ]
page_climb_act_2.link(button=asa.I_ACT_MAP_SWITCH, destination=page_climb_act_3)
page_climb_act_3.link(button=asa.I_ACT_MAP_SWITCH, destination=page_climb_act_2)
# 门票爬塔活动界面
...
page_climb_act_pass.link(button=G.I_BACK_Y, destination=page_climb_act_3)
page_climb_act_3.link(button=asa.I_ENTRY_ACTIVITY, destination=page_climb_act_pass)
# 体力爬塔活动界面
