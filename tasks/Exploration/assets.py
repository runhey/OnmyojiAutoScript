...
class ExplorationAssets: 
	...
	# 战后奖励宝箱 
	I_BATTLE_REWARD_BOX = RuleImage(roi_front=(705,225,55,45), roi_back=(141,68,901,547), threshold=0.8, method="Template matching", file="./tasks/Exploration/res/res_battle_reward_box.png")
	# 妖 
