...
class RyouToppaAssets: 
	...
	# Image Rule Assets
	# description 
	I_TOPPA_RECORD = RuleImage(roi_front=(68,633,64,39), roi_back=(48,594,118,108), threshold=0.8, method="Template matching", file="./tasks/RyouToppa/dev/res_toppa_record.png")
	# description 
	...
	# 寮击破奖励 
	I_RYOU_REWARD = RuleImage(roi_front=(145,419,241,40), roi_back=(122,390,340,84), threshold=0.8, method="Template matching", file="./tasks/RyouToppa/res/res_ryou_reward.png")
	# 勋章奖励标题 
