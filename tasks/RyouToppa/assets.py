...
class RyouToppaAssets: 
	...
	# Image Rule Assets
	# 寮突 
	I_RYOU_TOPPA = RuleImage(roi_front=(1197,358,68,110), roi_back=(1191,350,78,125), threshold=0.8, method="Template matching", file="./tasks/RyouToppa/res/res_ryou_toppa.png")
	# 寮突选择阴阳寮按钮 
