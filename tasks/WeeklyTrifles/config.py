...
class Trifles(BaseModel):
    ...
    save_touch_fish: bool = Field(default=False, description='save_touch_fish_help')
    broken_amulet: int = Field(
        title='Broken Amulet', default=100, description='trifles_broken_amulet_help'
    )
