...
class OrochiAssets: 
	...
	# 点击挑战 
	I_OROCHI_FIRE = RuleImage(roi_front=(1095,577,130,124), roi_back=(1095,577,130,122), threshold=0.6, method="Template matching", file="./tasks/Orochi/o/o_orochi_fire.png")
	# 式神录 
