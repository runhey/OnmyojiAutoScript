...
class OrochiAssets: 
	...
	# description 
	I_OROCHI_LOCK = RuleImage(roi_front=(573,559,31,32), roi_back=(548,554,65,54), threshold=0.8, method="Template matching", file="./tasks/Orochi/o/o_orochi_lock.png")
	# description 
	I_OROCHI_UNLOCK = RuleImage(roi_front=(575,558,26,29), roi_back=(560,553,56,40), threshold=0.8, method="Template matching", file="./tasks/Orochi/o/o_orochi_unlock.png")
	# 点击挑战 
	...
	I_OROCHI_WILD_FIRE = RuleImage(roi_front=(1179,602,81,87), roi_back=(1179,602,81,87), threshold=0.6, method="Template matching", file="./tasks/Orochi/o/o_orochi_wild_fire.png")
	# 式神录 
